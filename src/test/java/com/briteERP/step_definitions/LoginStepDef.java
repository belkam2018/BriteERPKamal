...
public class LoginStepDef {
    ...
    @And("User is on the login page as a user with {string} and {string} credentials")
    public void user_is_on_the_login_page_as_a_user_with_and_credentials(String email, String password) throws InterruptedException {
        logObj.signIn.click();
